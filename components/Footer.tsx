      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-16">
        ...
        <div>
           ...
           <ul className="space-y-6">
             ...
             <li><button onClick={() => onNavigate(View.TRACK_STATUS)} className="text-xs font-black text-slate-400 uppercase tracking-widest hover:text-white transition-colors">Track Status</button></li>
             <li><button onClick={() => onNavigate(View.ABOUT)} className="text-xs font-black text-slate-400 uppercase tracking-widest hover:text-white transition-colors">About Us</button></li>
